...
class TaskParams:
    ...
    robot_stiffness = 0.0 #10000000.0
    ...
    tcp_rand_range_roll = (-math.pi, -math.pi) #(0.0, 0.0)
    tcp_rand_range_pitch = (0.0, 0.0)#(math.pi, math.pi) #(math.pi, math.pi)
    tcp_rand_range_yaw = (0.0, 0.0)
    ...
    hole_randomize_pose_range_x = (0.0, 0.0) #(0.0, 0.0) #(-0.01, 0.01)
    hole_randomize_pose_range_y = (0.0, 0.0) #(0.0, 0.0) #(-0.01, 0.01)
